...
const EditModal = ({id, showw, onClose}) => {
    ...
    const editTransaction = async (e) => {
        ...
        try {
            await api.put(`/secondpage/update/${id}`, {
              marca: data.marca,
              valor: data.valor,
        ...
        <div className="modal">
            <div className="modal-content">
                ...
                <form className="modal-body" onSubmit={editTransaction}>
                    ...
                    <input type="text" value={values.marca}  onChange={(e) => {setValues({...values, marca:e.target.value})}}/>

                    <input type="number" value={values.quantidade}  onChange={(e) => {setValues({...values, quantidade:e.target.value})}}/>

                    <input type="number"value={values.valor}  onChange={(e) => {setValues({...values, valor:e.target.value})}}/>
                    ...
                    <button onClick={onClose} className="button">Fechar</button>
                </form>
